import { findMockMarketer, selectMockMarketers } from "@/features/marketers/mock-data";
import type { Marketer, MarketerQuery, MarketerSearchResult } from "@/features/marketers/types";
