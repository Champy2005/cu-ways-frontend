...
import { normalizeRegisterInput, registerValidationMessage } from "@/features/auth/schemas";
...
export function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        <label className="mb-2 block text-sm font-medium text-zinc-800" htmlFor="register-name">
          Name
        </label>
        <Input
          id="register-name"
      ...
      <div>
        <label className="mb-2 block text-sm font-medium text-zinc-800" htmlFor="register-email">
          Email
        </label>
        <Input
          id="register-email"
      ...
      <div>
        <label className="mb-2 block text-sm font-medium text-zinc-800" htmlFor="register-password">
          Password
        </label>
        <Input
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <div>
          <label className="mb-2 block text-sm font-medium text-zinc-800" htmlFor="register-phone">
        ...
        <div>
          <label
            ...
            htmlFor="register-line-id"
          >
            Line ID <span className="font-normal text-zinc-500">(optional)</span>
          </label>
          <Input
            id="register-line-id"
            value={values.line_id ?? ""}
            onChange={(event) => update("line_id", event.target.value)}
          />
        </div>
      </div>
      {error ? (
