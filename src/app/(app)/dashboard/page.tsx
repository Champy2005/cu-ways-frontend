...
export default function DashboardPage() {
  return (
    <div>
      ...
      <p className="mt-3 text-zinc-600">Your CU Ways workspace is ready. Choose an area to continue.</p>
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        {[
          ...
          <Link key={href} href={href} className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-zinc-400">
